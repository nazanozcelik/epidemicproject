...
public interface PageRouter {
    String routePage(String pageType, LinkType linkType) throws ResourceNotFoundException, SectionNotFoundException, URISyntaxException, LinkTypeNotFoundException;
}
